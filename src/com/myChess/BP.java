...
public class BP extends ChessPiece implements MouseListener{
	...
	public void init() {	
		...
		//去掉边框
		this.setBorder(null);
		ImageIcon icon = new ImageIcon("src\\images\\BP.GIF");
		this.setIcon(icon);
	}
	...
	public void setIconSelect(Boolean tf) {
		...
		if(tf == true) {
			ImageIcon icon = new ImageIcon("src\\images\\BPS.GIF");
			this.setIcon(icon);
		}
	}
