...
public class RN extends ChessPiece implements MouseListener{
	...
	public void init() {	
		...
		//去掉边框
		this.setBorder(null);
		ImageIcon icon = new ImageIcon("src\\images\\RN.GIF");
		this.setIcon(icon);
	}
	...
	public void setIconSelect(Boolean tf) {
		...
		if(tf == true) {
			ImageIcon icon = new ImageIcon("src\\images\\RNS.GIF");
			this.setIcon(icon);
		}
	}
	...
	public void mouseClicked(MouseEvent var1) {
		...
		if (c==MouseEvent.BUTTON1 && Data.BorRRun == true)// 
		{
		...
		else if (c==MouseEvent.BUTTON1 && Data.BorRRun == false) {
				Data.lastSelectPiece.setLocation(CurrentsimX, CurrentsimY);
				if(Data.BorRRun == true)
