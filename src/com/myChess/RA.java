...
public class RA extends ChessPiece implements MouseListener{
	...
	public void init() {	
		...
		//去掉边框
		this.setBorder(null);
		ImageIcon icon = new ImageIcon("src\\images\\RA.GIF");
		this.setIcon(icon);
	}
	...
	public void setIconSelect(Boolean tf) {
		...
		if(tf == true) {
			ImageIcon icon = new ImageIcon("src\\images\\RAS.GIF");
			this.setIcon(icon);
		}
	}
	...
	public void setLocation(int setsimX, int setsimY) {
		...
		if(setsimX>2&&setsimX<6&&setsimY>6) {
	...
	public void mouseClicked(MouseEvent var1) {
		...
		if (c==MouseEvent.BUTTON1 && Data.BorRRun==true)// 推断是鼠标左键按下且上一次走子的是黑子
		{
